                    ...
                    <td className="py-3 px-4">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-lg hover:bg-blue-500/30 transition-colors text-sm font-medium"
                        >
                          Sửa
                        </button>
                        <button
                          ...
                          className="px-3 py-1 bg-red-500/20 text-red-300 rounded-lg hover:bg-red-500/30 transition-colors text-sm font-medium"
                        >
                          Xóa
                        </button>
                      </div>
